<%@ Page Language="C#" MasterPageFile="~/CPanel/MasterPage.master"  AutoEventWireup="true" CodeFile="NotificationList.aspx.cs" Inherits="CPanel_NotificationList" %>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div style="padding-top: 5px;" align="right">
                            <a href="Notification_AddEdit.aspx" target="_parent" class="btn btn-link btn-sm"><strong>Add Notification <i class="fa fa-plus"></i></strong></a>
                        </div>
