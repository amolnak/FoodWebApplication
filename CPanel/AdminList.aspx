<%@ Page Language="C#" MasterPageFile="~/CPanel/MasterPage.master" AutoEventWireup="true" CodeFile="AdminList.aspx.cs" Inherits="CPanel_AdminList" %>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div style="padding-top: 5px;" align="right">
                            <a href="Admin_AddEdit.aspx" target="_parent" style="position: right" class="btn btn-link btn-sm"><strong>Add Admin <i class="fa fa-plus"></i></strong></a>
                        </div>
