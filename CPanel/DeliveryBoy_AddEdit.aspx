    ...
    <form id="form1" runat="server">
        ...
        <div class="page-title">
            <ul class="breadcrumb">
                ...
                <li>Settings</li>
                <li>Upload Master Translation</li>
            </ul>
        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-horizontal form-sm col-lg-12">
                                ...
                                <div class="row form-group">
                                    <div class="col col-md-3">
                                        <label class="control-label">Alternate Phone No<span class="text-danger">*</span></label>
                                    </div>
                                    <div class="col-6 col-md-2">
                                        <asp:TextBox ID="txtPhone2" runat="server" CssClass="form-control" placeholder="Enter phone no." MaxLength="15" TabIndex="8" />
                                        <asp:RequiredFieldValidator ID="reqfld_phone2" runat="server" ControlToValidate="txtPhone2" ErrorMessage="Please enter alternate phone no."
                                            Display="Dynamic" CssClass="text-danger" ValidationGroup="vg" EnableClientScript="true" />
                                    </div>
                                </div>
                                <div class="row form-group">
                                    ...
                                    <div class="col-6 col-md-2">
                                        <asp:DropDownList ID="ddlCity" runat="server" CssClass="form-control" TabIndex="9" />
                                        <asp:RequiredFieldValidator ID="reqfld_city" InitialValue="0" runat="server" ControlToValidate="ddlCity" ErrorMessage="Please select city."
                                            Display="Dynamic" CssClass="text-danger" ValidationGroup="vg" EnableClientScript="true" />
                                    </div>
                                </div>
                                <div class="row form-group">
                                    ...
                                    <div class="col-6 col-md-2">
                                        ...
                                        <asp:RequiredFieldValidator ID="reqfld_region" InitialValue="0" runat="server" ControlToValidate="ddlRegion" ErrorMessage="Please select region."
                                            Display="Dynamic" CssClass="text-danger" ValidationGroup="vg" EnableClientScript="true" />
                                    </div>
                                </div>
                                  ...
                                  <div class="row form-group">
                                    <div class="col col-md-3">
                                        <label class="control-label">License No<span class="text-danger">*</span></label>
                                    </div>
                                    <div class="col-6 col-md-2">
                                  ...
                                  <div class="row form-group">
                                    ...
                                    <div class="col-6 col-md-2">
                                        ...
                                        <asp:RequiredFieldValidator ID="reqfld_vehicle" InitialValue="0" runat="server" ControlToValidate="ddlVehicle" ErrorMessage="Please select vehicle."
                                            Display="Dynamic" CssClass="text-danger" ValidationGroup="vg" EnableClientScript="true" />
                                    </div>
                                </div>
                            </div>
